...
if(!empty($userData)){
    ...
    $query = "SELECT * FROM usersdata WHERE oauth_pro = '".$oauth_provider."' AND oauthid = '".$oauth_uid."'";
    ...
    if($result->num_rows > 0){
        ...
        // Insert user data
        $query = "INSERT INTO usersdata VALUES (NULL, '".$oauth_provider."', '".$oauth_uid."', '".$first_name."', '".$last_name."', '".$email."', '".$gender."', '".$locale."', '".$picture."', '".$link."', NOW())";
